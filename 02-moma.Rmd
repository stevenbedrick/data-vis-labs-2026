...
author: "Alison Hill, with (slight) modifications by Steven Bedrick"
subtitle: BMI 5/625
output:
  # pdf_document:
  #   toc: yes
...
The finished data set is available at [here](https://stevenbedrick.github.io/data-vis-labs-2026/data/artworks.csv), and is also present locally in the Posit Cloud project:
...
In the `?count` documentation, it says: "`count` and `tally` are designed so that you can call them repeatedly, each time rolling up a level of detail." Try running `count()` again (leave parentheses empty) on your last code chunk, like so:
...
<div class="panel panel-success">
  ...
  <div class="panel-body">
We'll do this together *(nothing to turn in)*: see [slides](https://stevenbedrick.github.io/data-vis-labs-2026/slides/02-slides.html#16).
  </div>
</div>
...
![](https://fivethirtyeight.com/wp-content/uploads/2015/08/roeder-feature-moma-1.png?w=1150)
...
- Go back to [Lab 01](https://stevenbedrick.github.io/data-vis-labs-2026/01-eda_hot_dogs.html) to review how to do the following:
...
![](https://fivethirtyeight.com/wp-content/uploads/2015/08/roeder-feature-moma-3.png?w=1150)

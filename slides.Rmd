---
title: "In-Class Slides & Reading for BMI5/625 Labs"
...
The following are all useful and *free* books, available to read online:
...
### 01b: `ggplot` refresher

```{r}
knitr::include_url("slides/01b-slides.html")
```
